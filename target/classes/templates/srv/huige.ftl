    ...
    <div id="page-content-wrapper">
        <div class="container-fluid">
            <div class="row clearfix">
                ...
                <div class="col-md-2 column">
                    <button type="button" class="btn btn-default btn-danger" onclick="huigeSrv()">回割</button>
                </div>
            </div>
...
<script>
    ...
    function huigeSrv() {
        ...
        if(res){
            ...
            $.ajax({
                type: "post",
                url: "/dns/srv/gelihuige?disable=false&sgw=" + sgw,
                contentType: 'application/json;charset=UTF-8',
                data: JSON.stringify(geliBody),
                success: function (data) {
                    alert("共回割了" + data.length + "条Srv记录！请重新查询记录状态确认结果！");
                }
            })
        }
